...
try {
    ...
    // Mail body content
    $bodyContent = "<p>Hãy nháy chuột vào <a href='http://localhost/BTL_CNweb/Browers/controllers/accuracy.php?confirmed=$confirmed&email=$email'>Bấm vào link để xác nhận</a>";
