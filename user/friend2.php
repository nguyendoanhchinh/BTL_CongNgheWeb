        ...
        <div class="d-flex flex-column">
            ...
            <nav class="nav-menu">  
                <ul>
                    ...
                    <li class="active"><a href="#"><i class="bx bx-book-content"></i> <span>Bài viết</span></a></li>
                    <li  class="active"><a href="#"><i class="bx bx-book-content"></i>Giới thiệu</a></li>
                    <li  class="active"><a href="#"><i class="bx bx-book-content"></i>Bạn bè</a></li>

                    <li  class="active"><a href="#"><i class="bx bx-book-content"></i> Ảnh</a></li>
                    <li  class="active"><a href="plan/plan.php"><i class="bx bx-file-blank"></i> <span>Video</span></a></li>
