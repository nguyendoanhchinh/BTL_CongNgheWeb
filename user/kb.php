                                    ...
                                    if(mysqli_num_rows($result12)>0){
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td><a href="list fr.php"><button class="btn btn-primary">chấp nhận</button></a></td>
                                            <td><a href="xoaNV.php?fr_id=<?php echo $row['fr_id']; ?>"><button class="btn btn-primary">Từ chối</button></a></td>
                                        </tr>
