    ...
    <header id="header">
        <div class="d-flex flex-column">
            ...
            <ul>
                    ...
                    <li><a href="search fr.php"><i class="bx bx-file-blank"></i> <span>Tìm bạn bè</span></a></li>
                    <li><a href="#portfolio"><i class="bx bx-book-content"></i> Portfolio</a></li>
                    <li><a href="#services"><i class="bx bx-server"></i> Services</a></li>
                    <li><a href="kb.php?us_id=<?php echo $row['us_id']; ?>"><i class="bx bx-envelope"></i>Lời mời kết bạn </a></li>
                                    ...
                                    if(mysqli_num_rows($result12)>0){
                                       ...
                                       ?>
                                        <tr>
                                            ...
                                            <td><?php echo $row['us_name']; ?> đã gửi lời mời cho bạn </td>
                                           
                                            <td><a href="#"><button class="btn btn-primary">chấp nhận</button></a></td>
                                            <td><a href="#"><button class="btn btn-primary">Từ chối</button></a></td>
                                        </tr>
